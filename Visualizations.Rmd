...
hist_income <- ggplot(data_clean, mapping = aes(x = income, fill = income), stat = "count") +
...
mosaicplot(table(mosaic_total), shade = TRUE)
```
...
CrossTable(table(mosaic_total_1), 
           digits = 2,
           prop.r = TRUE,
           prop.c = TRUE,
           prop.t = FALSE,
...
mosaicplot(table(mosaic_total_1), shade = TRUE)
```
